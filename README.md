...
| **Groq**          | ✅ Free tier                     | [console.groq.com](https://console.groq.com/)                                    | [console.groq.com/keys](https://console.groq.com/keys)                 | Extremely fast. Screenshots auto-use the free `llama-4-scout` vision model. |
